...
describe('CircleChart', () => {
  test('should render with values', () => {
    render(React.createElement(CircleChart, { value: 10, maxValue: 100 }));
  });

  test('should render when empty', () => {
    render(React.createElement(CircleChart, {}));
  });

  // todo: test percentage

  test('should display the prefix', () => {
    const { container } = render(React.createElement(CircleChart, { value: 10, maxValue: 100, prefix: 'smiles' }));
  ...
  test('should display the number correctly', () => {
    const { container } = render(React.createElement(
      CircleChart,
      { value: 12000.4, maxValue: 20000, decimals: 2 },
    ));
  ...
  test('should display the metric', () => {
    const { container } = render(React.createElement(
      CircleChart,
      { value: 10, maxValue: 100, metric: 'Kaas' },
    ));
  ...
  test('should display the postfix', () => {
    const { container } = render(React.createElement(
      CircleChart,
      { value: 10, maxValue: 100, postfix: 'per user' },
    ));
