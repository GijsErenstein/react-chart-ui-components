...
var BlueDot = styled.line(_templateObject4(), colors.interactive, HoverElement);
var LightBlueDot = styled.line(_templateObject5(), lightColors.interactive, HoverElement);
var TopLine = styled.line(_templateObject6(), colors.interactive);
var BottomLine = styled.line(_templateObject7(), HoverElement, colors.interactive);
var AxisLine = styled.div(_templateObject8(), colors.dark);
var AxisPoint = styled.div(_templateObject9(), colors.dark);
var AxisValue = styled.div(_templateObject10(), colors.dark, AxisPoint, AxisPoint);
var Value = styled.span(_templateObject11(), colors.white, spacings.small, colors.interactive, spacings.tiny, spacings.small, spacings.tiny, PopIn, colors.interactive);
var ChartFill = styled.polyline(_templateObject12(), colors.interactive, colors.interactive);
var ChartLine = styled.polyline(_templateObject13(), colors.interactive);
...
var Value$1 = styled.div(_templateObject2$1(), spacings.large, colors.interactive);
var Metric = styled.div(_templateObject3$1(), spacings.medium, colors.interactive);
var ValueAddition = styled.span(_templateObject4$1(), spacings.medium, colors.interactive);
var ChartContainer$1 = styled.svg(_templateObject5$1());
var CircleBackground = styled.circle(_templateObject6$1(), colors.interactive);
var CircleValue = styled.circle(_templateObject7$1(), colors.interactive);
...
function (_Component) {
  ...
  _createClass(CircleChart, [{
    ...
    value: function render() {
      ...
      return React.createElement(Container$1, null, React.createElement(ChartContainer$1, {
        ...
        cy: "16.91549431",
        r: "15.91549431"
      })), React.createElement(Value$1, null, React.createElement(ValueAddition, null, this.props.prefix), value, React.createElement(ValueAddition, null, this.props.postfix)), React.createElement(Metric, null, this.props.metric));
    }
  }]);
