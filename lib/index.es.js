...
function Button(_ref) {
  ...
  var StyledButton = styled.button(_templateObject(), color, contrastColor, spacings.tiny, spacings.large, spacings.medium, spacings.medium, lighterColor, lighterColor, lighterColor, lighterColor);
  return React.createElement(StyledButton, restProps, text);
}
...
var PopIn = keyframes(_templateObject$1(), spacings.small);
  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      ...
      var darkerColor = ColorChanger.darkenColor(color, 0.2),
          ...
          contrastColor = ColorChanger.getBlackOrWhiteContrastColor(color);
      var Container = styled.div(_templateObject$2(), spacings.large);
      var ChartContainer = styled.svg(_templateObject2());
      var HoverElement = styled.rect(_templateObject3());
      var BlueDot = styled.line(_templateObject4(), color, HoverElement);
      var LightBlueDot = styled.line(_templateObject5(), lighterColor, HoverElement);
      var TopLine = styled.line(_templateObject6(), color);
      var BottomLine = styled.line(_templateObject7(), HoverElement, color);
      ...
      var Value = styled.span(_templateObject11(), contrastColor, spacings.small, color, spacings.tiny, spacings.small, spacings.tiny, PopIn, color);
      var ChartFill = styled.path(_templateObject12(), color, color);
      var ChartPath = styled.path(_templateObject13(), color); // Calculate svg coordinates
...
function CircleChart(_ref) {
  ...
  var CircleValue = styled.circle(_templateObject$3(), color);
  var Container = styled.div(_templateObject2$1());
  var Value = styled.div(_templateObject3$1(), spacings.large, color);
  var Metric = styled.div(_templateObject4$1(), spacings.medium, color);
  var ValueAddition = styled.span(_templateObject5$1(), spacings.medium, color);
  var ChartContainer = styled.svg(_templateObject6$1());
  var CircleBackground = styled.circle(_templateObject7$1(), color);
  return React.createElement(Container, null, React.createElement(ChartContainer, {
    ...
    cy: "16.91549431",
    r: "15.91549431"
  })), React.createElement(Value, null, React.createElement(ValueAddition, null, prefix), formattedValue, React.createElement(ValueAddition, null, postfix)), React.createElement(Metric, null, metric));
}

export { Button, CircleChart, LineChart };
