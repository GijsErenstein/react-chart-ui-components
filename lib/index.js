  ...
  _createClass(ColorChanger, null, [{
    ...
    value: function lightenColor(color) {
      ...
      if (color && color.length >= 6) {
        ...
        return "#".concat(rgb[0].toString(16)).concat(rgb[1].toString(16)).concat(rgb[2].toString(16));
      }
    ...
    value: function darkenColor(color) {
      ...
      if (color && color.length >= 6) {
        ...
        var rgb = ColorChanger.hslToRgb(hsl[0], hsl[1], hsl[2]);
        var RR = rgb[0].toString(16).length < 2 ? "0".concat(rgb[0].toString(16)) : rgb[0].toString(16);
        var GG = rgb[1].toString(16).length < 2 ? "0".concat(rgb[1].toString(16)) : rgb[1].toString(16);
        var BB = rgb[2].toString(16).length < 2 ? "0".concat(rgb[2].toString(16)) : rgb[2].toString(16);
...
function Button(_ref) {
  var _ref$text = _ref.text,
      ...
      color = _ref$color === void 0 ? colors.interactive : _ref$color,
      restProps = _objectWithoutProperties(_ref, ["text", "color"]);

  var lighterColor = ColorChanger.lightenColor(color, 0.1),
      contrastColor = ColorChanger.getBlackOrWhiteContrastColor(color);
  var StyledButton = styled__default.button(_templateObject(), color, contrastColor, spacings.tiny, spacings.large, spacings.medium, spacings.medium, lighterColor, lighterColor, lighterColor, lighterColor);
  return React__default.createElement(StyledButton, restProps, text);
}
...
var PopIn = styled.keyframes(_templateObject$1(), spacings.small);

function formatNumber(number) {
  var decimals = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  var formattedNumber = "".concat(number.toFixed(decimals));
  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          _this$props$decimals = _this$props.decimals,
          decimals = _this$props$decimals === void 0 ? 2 : _this$props$decimals,
          _this$props$color = _this$props.color,
          color = _this$props$color === void 0 ? colors.interactive : _this$props$color,
          _this$props$rounded = _this$props.rounded,
          rounded = _this$props$rounded === void 0 ? false : _this$props$rounded,
          ...
          axis = _this$props$axis === void 0 ? [] : _this$props$axis,
          _this$props$prefix = _this$props.prefix,
          prefix = _this$props$prefix === void 0 ? null : _this$props$prefix,
          _this$props$postfix = _this$props.postfix,
          postfix = _this$props$postfix === void 0 ? null : _this$props$postfix,
          restProps = _objectWithoutProperties(_this$props, ["decimals", "color", "rounded", "values", "axis", "prefix", "postfix"]); // create colors


      var darkerColor = ColorChanger.darkenColor(color, 0.2),
          lighterColor = ColorChanger.lightenColor(color, 0.1),
          contrastColor = ColorChanger.getBlackOrWhiteContrastColor(color);
      var Container = styled__default.div(_templateObject$2(), spacings.large);
      var ChartContainer = styled__default.svg(_templateObject2());
      var HoverElement = styled__default.rect(_templateObject3());
      var BlueDot = styled__default.line(_templateObject4(), color, HoverElement);
      var LightBlueDot = styled__default.line(_templateObject5(), lighterColor, HoverElement);
      var TopLine = styled__default.line(_templateObject6(), color);
      var BottomLine = styled__default.line(_templateObject7(), HoverElement, color);
      var AxisLine = styled__default.div(_templateObject8(), darkerColor);
      var AxisPoint = styled__default.div(_templateObject9(), darkerColor);
      var AxisValue = styled__default.div(_templateObject10(), darkerColor, AxisPoint, AxisPoint);
      var Value = styled__default.span(_templateObject11(), contrastColor, spacings.small, color, spacings.tiny, spacings.small, spacings.tiny, PopIn, color);
      var ChartFill = styled__default.path(_templateObject12(), color, color);
      var ChartPath = styled__default.path(_templateObject13(), color); // Calculate svg coordinates
      ...
      }, React__default.createElement(ChartPath, {
        d: pathCoordinates
      ...
      }, prefix, " ", formatNumber(this.state.shownValue, decimals), " ", postfix) : null);
    }
    /**
     * @param value
     * @param position
    ...
    value: function formatCoordinatesAsPair() {
      ...
      var coordinates = [],
          maxValue = Math.max.apply(Math, [0].concat(_toConsumableArray(values))),
    ...
    value: function formatValuesForLine(command) {
      ...
      var coordinates = this.formatCoordinatesAsPair(values); // build the d attributes by looping over the points
    ...
    value: function formatValuesForFill(command) {
      ...
      var values = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
      var coordinates = this.formatCoordinatesAsPair(values),
          fillCoordinates = [[0, Math.max.apply(Math, _toConsumableArray(values))]].concat(_toConsumableArray(coordinates), [[100, Math.max.apply(Math, _toConsumableArray(values))]]);
...
function CircleChart(_ref) {
  var _ref$value = _ref.value,
      value = _ref$value === void 0 ? 0 : _ref$value,
      _ref$maxValue = _ref.maxValue,
      maxValue = _ref$maxValue === void 0 ? 0 : _ref$maxValue,
      _ref$decimals = _ref.decimals,
      decimals = _ref$decimals === void 0 ? 2 : _ref$decimals,
      _ref$color = _ref.color,
      color = _ref$color === void 0 ? colors.interactive : _ref$color,
      _ref$metric = _ref.metric,
      metric = _ref$metric === void 0 ? null : _ref$metric,
      _ref$prefix = _ref.prefix,
      prefix = _ref$prefix === void 0 ? null : _ref$prefix,
      _ref$postfix = _ref.postfix,
      postfix = _ref$postfix === void 0 ? null : _ref$postfix,
      props = _objectWithoutProperties(_ref, ["value", "maxValue", "decimals", "color", "metric", "prefix", "postfix"]);

  var percentage = value / maxValue * 100,
      formattedValue = formatNumber(value, decimals);
  var CircleValue = styled__default.circle(_templateObject$3(), color);
  var Container = styled__default.div(_templateObject2$1());
  var Value = styled__default.div(_templateObject3$1(), spacings.large, color);
  var Metric = styled__default.div(_templateObject4$1(), spacings.medium, color);
  var ValueAddition = styled__default.span(_templateObject5$1(), spacings.medium, color);
  var ChartContainer = styled__default.svg(_templateObject6$1());
  var CircleBackground = styled__default.circle(_templateObject7$1(), color);
  return React__default.createElement(Container, null, React__default.createElement(ChartContainer, {
    ...
    cy: "16.91549431",
    r: "15.91549431"
  })), React__default.createElement(Value, null, React__default.createElement(ValueAddition, null, prefix), formattedValue, React__default.createElement(ValueAddition, null, postfix)), React__default.createElement(Metric, null, metric));
}
