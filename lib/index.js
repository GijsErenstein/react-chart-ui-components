...
var Container = styled.div(_templateObject(), spacings.large);
...
var Value = styled.span(_templateObject8(), colors.white, spacings.small, colors.interactive, spacings.tiny, spacings.small, spacings.tiny, colors.interactive);
var ChartFill = styled.polyline(_templateObject9(), colors.interactive, colors.interactive);
var ChartLine = styled.polyline(_templateObject10(), colors.interactive);
  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      ...
      var maxValue = Math.max.apply(Math, _toConsumableArray(this.props.values)),
          ...
          fillCoordinates = [0, 100].concat(_toConsumableArray(lineCoordinates), [100, maxValue]),
...
var ChartContainer$1 = styled.svg(_templateObject$1());
var CircleBackground = styled.circle(_templateObject2$1(), lightColors.interactive);
var CircleValue = styled.circle(_templateObject3$1(), colors.interactive);
...
function (_Component) {
  ...
  _createClass(CircleChart, [{
    key: "render",
    value: function render() {
      var percentage = this.props.value / this.props.maxValue * 100;
      return React__default.createElement(ChartContainer$1, {
