...
function (_Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var StyledButton = styled__default.button(_templateObject(), uiColor, contrastColor, spacings.tiny, spacings.large, spacings.medium, spacings.medium, lighterColor, lighterColor, lighterColor, lighterColor);
      return React__default.createElement(StyledButton, this.props, this.props.text);
    }
  }]);
...
function (_Component) {
  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      ...
      var BlueDot = styled__default.line(_templateObject4(), uiColor, HoverElement);
      var LightBlueDot = styled__default.line(_templateObject5(), lighterColor, HoverElement);
      var TopLine = styled__default.line(_templateObject6(), uiColor);
      var BottomLine = styled__default.line(_templateObject7(), HoverElement, uiColor);
      ...
      var Value = styled__default.span(_templateObject11(), contrastColor, spacings.small, uiColor, spacings.tiny, spacings.small, spacings.tiny, PopIn, uiColor);
      var ChartFill = styled__default.path(_templateObject12(), uiColor, uiColor);
      var ChartPath = styled__default.path(_templateObject13(), uiColor); // Calculate svg coordinates
...
function (_Component) {
  ...
  _createClass(CircleChart, [{
    ...
    value: function render() {
      ...
      var uiColor = this.props.color ? this.props.color : colors.interactive;
      var CircleValue = styled__default.circle(_templateObject$3(), uiColor);
      var Container = styled__default.div(_templateObject2$1());
      var Value = styled__default.div(_templateObject3$1(), spacings.large, uiColor);
      var Metric = styled__default.div(_templateObject4$1(), spacings.medium, uiColor);
      var ValueAddition = styled__default.span(_templateObject5$1(), spacings.medium, uiColor);
      var ChartContainer = styled__default.svg(_templateObject6$1());
      var CircleBackground = styled__default.circle(_templateObject7$1(), uiColor);
      return React__default.createElement(Container, null, React__default.createElement(ChartContainer, {
        ...
        cy: "16.91549431",
        r: "15.91549431"
      })), React__default.createElement(Value, null, React__default.createElement(ValueAddition, null, this.props.prefix), value, React__default.createElement(ValueAddition, null, this.props.postfix)), React__default.createElement(Metric, null, this.props.metric));
    }
  }]);
